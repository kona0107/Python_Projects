...
# 엑셀 파일 읽기
file_path = r'/home/seunjung/매개모기/DMS_관측소_매핑.xlsx'
df = pd.read_excel(file_path, engine="openpyxl")
# 전년도 데이터
before_path = r'/home/seunjung/매개모기/data/2015_2023_daily_data.xlsx'
...
var = 'var='
option = "authKey=JlbExzOLQ1GWxMczizNRPw"  # 인증키
...
def fetch_and_process_all_years(df):
    ...
    full_data.to_excel("2015_2024_daily_data.xlsx", index=False)
...
#   년, 월 컬럼을 제외하고 저장
    ...
    # 결과 저장
    final_processed_data.to_excel("2015_2024_mosquito.xlsx", index=False)
