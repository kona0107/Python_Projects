...
def processed_data(last):
    ...
    # dataset.drop('landscape', axis=1, inplace=True) 삭제 
    ...
    # x,y 분리 후 스케일링 진행했으므로 스케일링 해제 불필요
    return scaler, X_train_scaled, X_test_scaled, y_train, y_test, X_train, train_data_sorted, test_data_sorted

if __name__ == "__main__" :
    data = pd.read_excel("F:/박정현/ML/machine_learning_project/data/weather/2015_2024_daily_data.xlsx")
